...
fn failure_category_filter_sql(category: &str) -> Option<&'static str> {
    match category {
        ...
        "sftp" => Some("error_code LIKE 'sftp_%'"),
        "dash" => Some("error_code LIKE 'dash_%'"),
        "metalink" => Some("error_code LIKE 'metalink_%'"),
        ...
        "other" => Some("(error_code IS NOT NULL AND error_code NOT IN ('remote_changed', 'resume_unavailable', 'temp_file_missing', 'temp_file_smaller_than_progress', 'disk_write_failed', 'auth_headers_expired', 'auth_headers_unavailable', 'server_rate_limited') AND error_code NOT LIKE 'http_%' AND error_code NOT LIKE 'hls_%' AND error_code NOT LIKE 'dash_%' AND error_code NOT LIKE 'metalink_%' AND error_code NOT LIKE 'bt_%' AND error_code NOT LIKE 'ftp_%' AND error_code NOT LIKE 'sftp_%' AND error_code NOT LIKE 'webdav_%' AND error_code NOT LIKE 'proxy_%' AND error_code NOT LIKE 'schedule_%')"),
        _ => None,
    }
}
...
pub async fn task_filter_options(pool: &SqlitePool) -> Result<TaskFilterOptions, String> {
    ...
    let mut failure_categories = error_rows
        ...
        .map(|category| match category {
            ...
            crate::models::TaskFailureCategory::Sftp => "sftp",
