...
pub use task::{
    ...
    HlsVariant, MetalinkChecksum, MetalinkFile, MetalinkProbeData, MetalinkResource,
    ProbeTaskPayload, ProbedFile, RecoveryAction, RequestDiagnostic, RequestDiagnosticRecord,
    SegmentStatus, SegmentSummary, SftpDirectoryEntry, SftpDirectoryProbe, Task, TaskChecksum,
    TaskChecksumRecord, TaskEvent, TaskFailureCategory, TaskFile, TaskFileRecord, TaskKind,
    TaskPriority, TaskProgressPayload, TaskProxyMode, TaskProxySettings, TaskProxySettingsInput,
