...
pub use task::{
    ...
    HlsVariant, HlsMediaTrack, MetalinkChecksum, MetalinkFile, MetalinkProbeData, MetalinkResource,
    ProbeTaskPayload, ProbedFile, RecoveryAction, RequestDiagnostic, RequestDiagnosticRecord,
    ScaleStateDistribution, SegmentStatus, SegmentSummary, SftpDirectoryEntry,
