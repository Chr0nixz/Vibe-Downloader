const zhCN = {
  ...
  newDownload: {
    ...
    batchUrlsPlaceholder: "每行粘贴一个 HTTP/HTTPS、FTP/FTPS、磁力链接、.torrent 或 Metalink URL",
    previewBatch: "\u9884\u89c8\u6279\u91cf",
    createBatch: "\u521b\u5efa\u6279\u91cf",
    batchSummary:
    ...
    manifestProtocolHint: "Torrent 和 Metalink 清单可展开为多个可选文件；浏览器 handoff 仍仅支持 HTTP/HTTPS。",
