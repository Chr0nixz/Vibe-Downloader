const zhCN = {
  ...
  newDownload: {
    ...
    url: "URL",
    urlPlaceholder: "https://example.com/file.zip、ftp://mirror/file.iso 或 magnet:?xt=...",
    detect: "\u68c0\u6d4b",
    detecting: "\u68c0\u6d4b\u4e2d\u2026",
    detectHint: "\u7acb\u5373\u9a8c\u8bc1 URL",
    ...
    batchUrls: "\u6279\u91cf URL",
    batchUrlsPlaceholder: "每行粘贴一个 HTTP/HTTPS、FTP/FTPS、磁力链接或 .torrent URL",
    previewBatch: "\u9884\u89c8\u6279\u91cf",
    createBatch: "\u521b\u5efa\u6279\u91cf",
    batchSummary:
  ...
  taskDetails: {
    ...
    btNoRuntime: "此任务暂时没有 BitTorrent 运行数据。",
    btMetadataStatus: "元数据",
    btPeers: "Peer / 种子",
    btPieces: "分片",
    btUpload: "已上传 / 上传速度",
    btRatio: "分享率",
    btSpeedLimitUnsupported: "暂不支持 BT 单任务限速。",
    close: "\u5173\u95ed\u8be6\u60c5",
    closeBackdrop: "\u5173\u95ed\u8be6\u60c5",
    drawerAria: "\u4efb\u52a1\u8be6\u60c5",
